/* === Wealth Factory Cash Flow Mastery App - Clean Version === */
...
class CashFlowMastery {
    ...
    async manualSave() {
        // Use the global email functions if user is logged in
        if (window.currentUser) {
            ...
            this.saveData();
            this.showNotification('Data saved locally. Enter your email above to save to cloud.', 'warning');
        }
    }
...
For a detailed breakdown of all categories and specific line items, please access the full dashboard.
